...
class AppExplanations {
  static List<ExplanationItem> getExplanations() {
  ...
  static List<ExplanationItem> getOfferRequestExplanations() {
    bool isAr = Get.locale?.languageCode == 'ar';
  ...
  // --- Panels ---
  static List<ExplanationItem> getPanelExplanations() {
    bool isAr = Get.locale?.languageCode == 'ar';
    return isAr
        ? [
  ...
  // --- Inverter ---
  static List<ExplanationItem> getInverterExplanations() {
    bool isAr = Get.locale?.languageCode == 'ar';
    return isAr
        ? [
  ...
  // --- Battery ---
  static List<ExplanationItem> getBatteryExplanations() {
    bool isAr = Get.locale?.languageCode == 'ar';
    return isAr
        ? [
  ...
  // --- Wires ---
  static List<ExplanationItem> getWiresExplanations() {
    bool isAr = Get.locale?.languageCode == 'ar';
    return isAr
        ? [
  ...
  // --- Pump ---
  static List<ExplanationItem> getPumpExplanations() {
    bool isAr = Get.locale?.languageCode == 'ar';
    return isAr
        ? [
  ...
  // --- Direction ---
  static List<ExplanationItem> getDirectionExplanations() {
    bool isAr = Get.locale?.languageCode == 'ar';
    return isAr
        ? [

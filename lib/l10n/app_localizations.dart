...
abstract class AppLocalizations {
  ...
  /// No description provided for @pv_system_designer_title.
  ///
  /// In en, this message translates to:
  /// **'PV System Designer'**
  String get pv_system_designer_title;

  /// No description provided for @pv_system_designer_desc.
  ///
  /// In en, this message translates to:
  /// **'Design a complete PV installation: roof layout, shadows, structure, and energy output.'**
  String get pv_system_designer_desc;

  /// No description provided for @pv_design_step_site.
  ///
  /// In en, this message translates to:
  /// **'Site'**
  String get pv_design_step_site;

  /// No description provided for @pv_design_step_roof.
  ///
  /// In en, this message translates to:
  /// **'Roof'**
  String get pv_design_step_roof;

  /// No description provided for @pv_design_step_panels.
  ///
  /// In en, this message translates to:
  /// **'Panels'**
  String get pv_design_step_panels;

  /// No description provided for @pv_design_step_shadows.
  ///
  /// In en, this message translates to:
  /// **'Shadows'**
  String get pv_design_step_shadows;

  /// No description provided for @pv_design_step_structure.
  ///
  /// In en, this message translates to:
  /// **'Structure'**
  String get pv_design_step_structure;

  /// No description provided for @pv_design_step_proposal.
  ///
  /// In en, this message translates to:
  /// **'Proposal'**
  String get pv_design_step_proposal;

  /// No description provided for @pv_design_site_location.
  ///
  /// In en, this message translates to:
  /// **'Site Location'**
  String get pv_design_site_location;

  /// No description provided for @pv_design_location_name.
  ///
  /// In en, this message translates to:
  /// **'Location name'**
  String get pv_design_location_name;

  /// No description provided for @pv_design_latitude.
  ///
  /// In en, this message translates to:
  /// **'Latitude'**
  String get pv_design_latitude;

  /// No description provided for @pv_design_longitude.
  ///
  /// In en, this message translates to:
  /// **'Longitude'**
  String get pv_design_longitude;

  /// No description provided for @pv_design_use_location.
  ///
  /// In en, this message translates to:
  /// **'Use current location'**
  String get pv_design_use_location;

  /// No description provided for @pv_design_roof_dimensions.
  ///
  /// In en, this message translates to:
  /// **'Roof / Site Dimensions'**
  String get pv_design_roof_dimensions;

  /// No description provided for @pv_design_width.
  ///
  /// In en, this message translates to:
  /// **'Width'**
  String get pv_design_width;

  /// No description provided for @pv_design_length.
  ///
  /// In en, this message translates to:
  /// **'Length'**
  String get pv_design_length;

  /// No description provided for @pv_design_tilt_azimuth.
  ///
  /// In en, this message translates to:
  /// **'Tilt & Azimuth'**
  String get pv_design_tilt_azimuth;

  /// No description provided for @pv_design_pitch.
  ///
  /// In en, this message translates to:
  /// **'Pitch'**
  String get pv_design_pitch;

  /// No description provided for @pv_design_azimuth.
  ///
  /// In en, this message translates to:
  /// **'Azimuth'**
  String get pv_design_azimuth;

  /// No description provided for @pv_design_clearances.
  ///
  /// In en, this message translates to:
  /// **'Clearances'**
  String get pv_design_clearances;

  /// No description provided for @pv_design_setback.
  ///
  /// In en, this message translates to:
  /// **'Wall setback'**
  String get pv_design_setback;

  /// No description provided for @pv_design_front_clearance.
  ///
  /// In en, this message translates to:
  /// **'Front'**
  String get pv_design_front_clearance;

  /// No description provided for @pv_design_rear_clearance.
  ///
  /// In en, this message translates to:
  /// **'Rear'**
  String get pv_design_rear_clearance;

  /// No description provided for @pv_design_side_clearance.
  ///
  /// In en, this message translates to:
  /// **'Side'**
  String get pv_design_side_clearance;

  /// No description provided for @pv_design_leg_clearance.
  ///
  /// In en, this message translates to:
  /// **'Leg clearance'**
  String get pv_design_leg_clearance;

  /// No description provided for @pv_design_row_gap.
  ///
  /// In en, this message translates to:
  /// **'Row gap'**
  String get pv_design_row_gap;

  /// No description provided for @pv_design_economics.
  ///
  /// In en, this message translates to:
  /// **'Economics'**
  String get pv_design_economics;

  /// No description provided for @pv_design_tariff.
  ///
  /// In en, this message translates to:
  /// **'Electricity tariff'**
  String get pv_design_tariff;

  /// No description provided for @pv_design_panel_power.
  ///
  /// In en, this message translates to:
  /// **'Panel power'**
  String get pv_design_panel_power;

  /// No description provided for @pv_design_panel_length.
  ///
  /// In en, this message translates to:
  /// **'Panel length'**
  String get pv_design_panel_length;

  /// No description provided for @pv_design_panel_width.
  ///
  /// In en, this message translates to:
  /// **'Panel width'**
  String get pv_design_panel_width;

  /// No description provided for @pv_design_panel_weight.
  ///
  /// In en, this message translates to:
  /// **'Panel weight'**
  String get pv_design_panel_weight;

  /// No description provided for @pv_design_auto_place.
  ///
  /// In en, this message translates to:
  /// **'Auto-place panels'**
  String get pv_design_auto_place;

  /// No description provided for @pv_design_clear_panels.
  ///
  /// In en, this message translates to:
  /// **'Clear panels'**
  String get pv_design_clear_panels;

  /// No description provided for @pv_design_shadow_time.
  ///
  /// In en, this message translates to:
  /// **'Time: {time}'**
  String pv_design_shadow_time(Object time);

  /// No description provided for @pv_design_winter_solstice.
  ///
  /// In en, this message translates to:
  /// **'Winter'**
  String get pv_design_winter_solstice;

  /// No description provided for @pv_design_summer_solstice.
  ///
  /// In en, this message translates to:
  /// **'Summer'**
  String get pv_design_summer_solstice;

  /// No description provided for @pv_design_calculating_structure.
  ///
  /// In en, this message translates to:
  /// **'Calculating structure...'**
  String get pv_design_calculating_structure;

  /// No description provided for @pv_design_layout_summary.
  ///
  /// In en, this message translates to:
  /// **'Layout Summary'**
  String get pv_design_layout_summary;

  /// No description provided for @pv_design_rows.
  ///
  /// In en, this message translates to:
  /// **'Rows'**
  String get pv_design_rows;

  /// No description provided for @pv_design_columns.
  ///
  /// In en, this message translates to:
  /// **'Columns'**
  String get pv_design_columns;

  /// No description provided for @pv_design_frame_width.
  ///
  /// In en, this message translates to:
  /// **'Frame width'**
  String get pv_design_frame_width;

  /// No description provided for @pv_design_row_spacing.
  ///
  /// In en, this message translates to:
  /// **'Row spacing'**
  String get pv_design_row_spacing;

  /// No description provided for @pv_design_leg_heights.
  ///
  /// In en, this message translates to:
  /// **'Leg Heights'**
  String get pv_design_leg_heights;

  /// No description provided for @pv_design_front_leg.
  ///
  /// In en, this message translates to:
  /// **'Front leg'**
  String get pv_design_front_leg;

  /// No description provided for @pv_design_rear_leg.
  ///
  /// In en, this message translates to:
  /// **'Rear leg'**
  String get pv_design_rear_leg;

  /// No description provided for @pv_design_bom.
  ///
  /// In en, this message translates to:
  /// **'Bill of Materials'**
  String get pv_design_bom;

  /// No description provided for @pv_design_system_summary.
  ///
  /// In en, this message translates to:
  /// **'System Summary'**
  String get pv_design_system_summary;

  /// No description provided for @pv_design_peak_power.
  ///
  /// In en, this message translates to:
  /// **'Peak power'**
  String get pv_design_peak_power;

  /// No description provided for @pv_design_total_area.
  ///
  /// In en, this message translates to:
  /// **'Total area'**
  String get pv_design_total_area;

  /// No description provided for @pv_design_total_weight.
  ///
  /// In en, this message translates to:
  /// **'Total weight'**
  String get pv_design_total_weight;

  /// No description provided for @pv_design_energy_estimate.
  ///
  /// In en, this message translates to:
  /// **'Energy Estimate'**
  String get pv_design_energy_estimate;

  /// No description provided for @pv_design_yearly_energy.
  ///
  /// In en, this message translates to:
  /// **'Yearly energy'**
  String get pv_design_yearly_energy;

  /// No description provided for @pv_design_capacity_factor.
  ///
  /// In en, this message translates to:
  /// **'Capacity factor'**
  String get pv_design_capacity_factor;

  /// No description provided for @pv_design_co2_offset.
  ///
  /// In en, this message translates to:
  /// **'CO₂ offset'**
  String get pv_design_co2_offset;

  /// No description provided for @pv_design_estimated_savings.
  ///
  /// In en, this message translates to:
  /// **'Estimated savings'**
  String get pv_design_estimated_savings;

  /// No description provided for @pv_design_data_source.
  ///
  /// In en, this message translates to:
  /// **'Data source'**
  String get pv_design_data_source;

  /// No description provided for @pv_design_monthly_energy.
  ///
  /// In en, this message translates to:
  /// **'Monthly Energy'**
  String get pv_design_monthly_energy;

  /// No description provided for @pv_design_save_project.
  ///
  /// In en, this message translates to:
  /// **'Save project'**
  String get pv_design_save_project;

  /// No description provided for @pv_design_finish.
  ///
  /// In en, this message translates to:
  /// **'Finish'**
  String get pv_design_finish;

  /// No description provided for @pv_design_panel_count.
  ///
  /// In en, this message translates to:
  /// **'Panel count'**
  String get pv_design_panel_count;
}

              ...
              children: [
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Column(
                      ...
                      children: [
                        pw.Text('invoice_upper'.tr, style: boldStyle.copyWith(fontSize: 30, color: PdfColors.blue900)),
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Text('bill_to'.tr, style: boldStyle),
                      pw.Text(buyerInfo?['name'] ?? 'guest'.tr, style: boldStyle),
                    ...
                    pw.TableRow(
                      ...
                      children: [
                        pw.Padding(
                          ...
                          child: pw.Text('item_description'.tr, style: boldStyle),
                        ),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(8),
                          child: pw.Text('qty_th'.tr, textAlign: pw.TextAlign.center, style: boldStyle),
                        ),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(8),
                          child: pw.Text('price_th'.tr, textAlign: pw.TextAlign.center, style: boldStyle),
                        ),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(8),
                          child: pw.Text('amount_th'.tr, textAlign: pw.TextAlign.center, style: boldStyle),
                        ),
                      ],
                    ),
                    // Item Rows
                    ...items.map((item) {
                      final name = item['product_name_snapshot'] ?? 'product_default'.tr;
                      ...
                      child: pw.Column(
                        children: [
                          pw.Row(
                            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                            children: [
                              pw.Text('total_amount'.tr, style: boldStyle),
                          ...
                          pw.Row(
                            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                            children: [
                              pw.Text('paid_amount'.tr, style: boldStyle),
                          ...
                          pw.Row(
                            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                            children: [
                              pw.Text('balance_due'.tr, style: boldStyle.copyWith(color: due > 0 ? PdfColors.red : PdfColors.black)),
                ...
                if (paymentMethod != null) ...[pw.SizedBox(height: 20), pw.Text("${'payment_method_label'.tr}: ${paymentMethod.tr}", style: boldStyle)],

                pw.Spacer(),
                pw.Divider(color: PdfColors.grey300),
                pw.Center(
                  child: pw.Text('thank_you'.tr, style: const pw.TextStyle(color: PdfColors.grey600)),
                ),
              ],
            ),
          );
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    pw.Text('account_statement'.tr, style: boldStyle.copyWith(fontSize: 24)),
                ...
                // Customer Info
                pw.Text('customer_details'.tr, style: boldStyle),
                ...
                // Transactions Table
                pw.Text('transaction_history'.tr, style: boldStyle),
                  ...
                  children: [
                    ...
                    pw.TableRow(
                      ...
                      children: [
                        ...
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(5),
                          child: pw.Text('order_label'.tr, style: boldStyle),
                        ),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(5),
                          child: pw.Text('total'.tr, style: boldStyle),
                        ),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(5),
                        ...
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(5),
                          child: pw.Text('offer_status'.tr, style: boldStyle),
                        ),
                      ],
                    ),
                    // Rows
                    ...orders.map((order) {
                      ...
                      return pw.TableRow(
                        children: [
                          ...
                          pw.Padding(padding: const pw.EdgeInsets.all(5), child: pw.Text(status.tr)),
                        ],
                      );
                    }),
                  ],
                ...
                pw.Spacer(),
                pw.Text('generated_by'.trParams({'app': 'Solar Hub'}), style: const pw.TextStyle(fontSize: 10, color: PdfColors.grey)),
              ],
            ),
          );
        },

...
class CompanyServiceRequestRepositoryImpl implements CompanyServiceRequestRepository {
  final CompanyServiceRequestRemoteDataSource _remoteDataSource;

  CompanyServiceRequestRepositoryImpl(this._remoteDataSource);

  @override
  Future<void> createServiceRequest({required int companyId, required String serviceCode, String? notes, MultipartFile? imageFile}) async {
    await _remoteDataSource.createServiceRequest(companyId: companyId, serviceCode: serviceCode, notes: notes, imageFile: imageFile);
  }
}

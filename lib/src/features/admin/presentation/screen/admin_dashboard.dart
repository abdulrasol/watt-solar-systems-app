    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          // Icon(Iconsax.convert_outline, size: 80.sp, color: AppTheme.primaryColor.withValues(alpha: 0.3)),
  ...
  Widget _buildHeaderSection(BuildContext context, AdminState state, bool isDark) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isDark ? Colors.white.withValues(alpha: 0.1) : AppTheme.primaryColor.withValues(alpha: 0.2), width: 1.5.w),
        boxShadow: [BoxShadow(color: AppTheme.primaryColor.withValues(alpha: 0.1), blurRadius: 20, offset: Offset(0, 10.h))],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(color: AppTheme.primaryColor.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(16.r)),
        ...
        GridView.count(
          ...
          children: [
            ...
            _buildStatCard(
              ...
              isDark,
              onTap: () {
                // TODO: Implement companies management
              },
            ),
            _buildStatCard(context, 'New Users', '5', Iconsax.people_bold, Colors.green, isDark, onTap: () {}),
            _buildStatCard(context, 'Pending Reviews', '3', Iconsax.star_bold, Colors.purple, isDark, onTap: () {}),
          ],
        ),
      ],
  ...
  Widget _buildQuickActionsSection(BuildContext context, bool isDark) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 16.h),
        _buildActionTile(context, 'Manage Companies', 'View and approve registered solar companies', Iconsax.building_bold, () {}, isDark),
        SizedBox(height: 12.h),
        _buildActionTile(
          context,
          'User Feedbacks',

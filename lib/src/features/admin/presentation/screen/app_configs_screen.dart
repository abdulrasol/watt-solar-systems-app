  ...
  Widget _buildLoadingState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Iconsax.setting_bold, size: 80.sp, color: AppTheme.primaryColor.withValues(alpha: 0.3)),
        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: config.value ? AppTheme.successColor.withValues(alpha: 0.1) : Colors.grey.withValues(alpha: 0.1),

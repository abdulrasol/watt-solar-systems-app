  ...
  Widget _buildStatChip({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: color.withValues(alpha: isDark ? 0.15 : 0.25), width: 1),
      ),
      child: Row(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                label,
                style: TextStyle(fontSize: 8.sp, color: isDark ? Colors.white60 : Colors.black54, fontWeight: FontWeight.bold),
              ),
              Text(
                value,
                style: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.w900, color: isDark ? Colors.white : Colors.black87),
              ),
            ],
          ),
        ],
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(color: const Color(0xFF1B2523).withValues(alpha: 0.1), width: 1.5),
          top: BorderSide(color: const Color(0xFF1B2523).withValues(alpha: 0.05), width: 1.0),
        ),
      ),

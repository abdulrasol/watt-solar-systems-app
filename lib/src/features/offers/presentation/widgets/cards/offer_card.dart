        ...
        child: Column(
          children: [
              ...
              children: [
                CircleAvatar(
                  ...
                  child: offer.company.logo != null
                      ...
                      : const Icon(Iconsax.building, color: AppTheme.primaryColor),
                ),
                SizedBox(width: 12.w),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(fontSize: 11.sp, color: onSurface.withValues(alpha: 0.58)),
                      ),
                    ],
                  ),
                ),
            ...
            Container(
              ...
              decoration: BoxDecoration(color: onSurface.withValues(alpha: 0.04), borderRadius: BorderRadius.circular(14.r)),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  _buildMiniSpec(Iconsax.sun_1, '${offer.totalPanelPower}W'),
                  _buildMiniSpec(Iconsax.flash_1, '${_formatNumber(offer.totalBatteryPower)}KWh'),
                  _buildMiniSpec(Iconsax.setting_2, '${_formatNumber(offer.inverterSize)}W'),
                ],
              ),
            ),
            if (offer.involves != null && offer.involves!.isNotEmpty) ...[
              Padding(
                ...
                child: Divider(height: 1, color: onSurface.withValues(alpha: 0.08)),
              ),
              ...offer.involves!.map(
                (item) => Padding(

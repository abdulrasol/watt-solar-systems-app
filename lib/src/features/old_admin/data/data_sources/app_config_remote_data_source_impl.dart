...
class AppConfigRemoteDataSourceImpl implements AppConfigRemoteDataSource {
  ...
  Future<List<AppConfig>> getAllConfigs() async {
    try {
      ...
      dPrint('getAllConfigs error: $e', stackTrace: stackTrace, tag: 'AppConfigRemoteDataSource');
      rethrow;
    }
  }
  ...
  Future<AppConfig> createConfig(AppConfig config) async {
    try {
      ...
      dPrint('createConfig error: $e', stackTrace: stackTrace, tag: 'AppConfigRemoteDataSource');
      rethrow;
    }
  }
  ...
  Future<AppConfig> updateConfig(String key, AppConfig config) async {
    try {
      ...
      dPrint('updateConfig error: $e', stackTrace: stackTrace, tag: 'AppConfigRemoteDataSource');
      rethrow;
    }
  }
  ...
  Future<void> deleteConfig(String key) async {
    try {
      ...
      dPrint('deleteConfig error: $e', stackTrace: stackTrace, tag: 'AppConfigRemoteDataSource');
      rethrow;
    }
  }
  ...
  Future<AppConfig> toggleConfig(String key, bool value) async {
    try {
      ...
      dPrint('toggleConfig error: $e', stackTrace: stackTrace, tag: 'AppConfigRemoteDataSource');
      rethrow;
    }
  }
}

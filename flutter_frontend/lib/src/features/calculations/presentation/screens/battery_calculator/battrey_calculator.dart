        ...
        headerSliverBuilder: (context, innerBoxIsScrolled) {
          return [
            SliverAppBar(
              ...
              title: Text(AppLocalizations.of(context)!.battery_calculator_title, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ...
              bottom: TabBar(
                ...
                tabs: [
                  Tab(icon: const Icon(Iconsax.timer), text: AppLocalizations.of(context)!.time_calculate),
                  Tab(icon: const Icon(Iconsax.battery_full), text: AppLocalizations.of(context)!.count_calculate),
                ],
              ),
            ),
          ];

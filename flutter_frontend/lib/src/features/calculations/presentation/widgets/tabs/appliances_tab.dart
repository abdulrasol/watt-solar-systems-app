...
class SystemAppliancesTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalLoad = controller.appliances.fold(0.0, (sum, a) => sum + a.power * a.quantity);
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  ...
                  style: TextStyle(fontSize: 12, height: 1.35, color: isDark ? Colors.white70 : Colors.grey.shade700),
                ),
              ),
            ],
          ),
        ...
        AnimatedSize(
          ...
          child: controller.appliances.isEmpty
              ...
              : Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Iconsax.electricity, color: AppTheme.primaryColor, size: 18),
                      const SizedBox(width: 8),
                      Text(
                        l10n.appliances_count_label(controller.appliances.length),
                        style: const TextStyle(fontWeight: FontWeight.w600, color: AppTheme.primaryColor, fontSize: 13),
                      ),
                      const Spacer(),
                      Text(
                        l10n.total_load_watts_label(totalLoad.toStringAsFixed(0)),
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: IconButton(
                  onPressed: () {
                    ExplanationDialog.show(context, explanations: [AppExplanations(context).getExplanations()[0]]);
                  },

    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(l10n.app_preferences, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ...
            Text(l10n.localization, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 16),
            ...
            if (ref.read(authProvider).isCompanyMember || ref.read(authProvider).isSuperUser) ...[
              const SizedBox(height: 24),
              Text(l10n.startup_roles, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: 16),

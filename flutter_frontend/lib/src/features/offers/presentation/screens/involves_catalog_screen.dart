...
class _InvolvesCatalogScreenState extends ConsumerState<InvolvesCatalogScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PreScaffold(
      ...
      actions: [IconButton(onPressed: () => _openInvolveEditor(), icon: const Icon(Iconsax.add_circle))],
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: isDark ? [const Color(0xFF14231F), const Color(0xFF10171A)] : [const Color(0xFFEAF7F1), const Color(0xFFFFFFFF)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(24.r),
        border: Border.all(color: isDark ? onSurface.withValues(alpha: 0.08) : const Color(0xFFC7E6D7)),
      ),
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(fontSize: 12.sp, color: onSurface.withValues(alpha: 0.72), height: 1.5),
          ),
        ],
      ),
    );
  ...
  Widget _buildEmptyState(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Icon(Iconsax.box_search, size: 42.sp, color: onSurface.withValues(alpha: 0.45)),
          ...
          ElevatedButton.icon(onPressed: () => _openInvolveEditor(), icon: const Icon(Iconsax.add_circle), label: Text(l10n.create_item)),
        ],
      ),
    );
  }
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Iconsax.receipt_item, color: AppTheme.primaryColor),
          ),
          SizedBox(width: 12.w),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 11.sp, color: onSurface.withValues(alpha: 0.65)),
                ),
              ],
            ),
          ),

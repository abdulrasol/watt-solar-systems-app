  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(colors: [Color(0xFF0D3B66), Color(0xFF168AAD)], begin: Alignment.topLeft, end: Alignment.bottomRight),
      ...
      child: Column(
        ...
        children: [
                  ...
                  children: [
                    ...
                    if ((company.companyType?.name ?? '').isNotEmpty)
                      Container(
                        ...
                        decoration: BoxDecoration(color: Colors.white.withValues(alpha: 0.14), borderRadius: BorderRadius.circular(999.r)),
                        child: Text(
          ...
          if ((company.description ?? '').trim().isNotEmpty) ...[
            ...
            Text(
              company.description!,
              style: TextStyle(fontSize: 13.sp, color: Colors.white.withValues(alpha: 0.9), height: 1.5),
            ),
          ],
        ],
      ),

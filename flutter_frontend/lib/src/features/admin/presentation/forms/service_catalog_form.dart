...
import 'package:watt/src/features/admin/presentation/widgets/beautiful_mention.dart';
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  if (isMobile)
                    Column(children: [_buildTextField('Category', _categoryController), const SizedBox(height: 16), _buildTextField('Route', _routeController)])
                  else
                    Row(
                      children: [
    ...
    return Row(
      ...
      children: [
        Text(
          ...
          style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, fontFamily: AppTheme.fontFamily),
        ),
        IconButton(
  ...
  Widget _buildSwitch() {
    return Row(
      children: [
        Text(
          'Active Status',
          style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, fontFamily: AppTheme.fontFamily),
        ),
        const Spacer(),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          ...
          style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, fontFamily: AppTheme.fontFamily),
        ),
      ),
    );
  }

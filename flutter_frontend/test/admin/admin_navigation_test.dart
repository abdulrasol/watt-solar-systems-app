      ...
      routes: [
        ShellRoute(
          ...
          routes: [
            ...
            GoRoute(path: '/admin/feedbacks', builder: (context, state) => const AdminFeedbacksScreen()),
            GoRoute(path: '/admin/configs', builder: (context, state) => const AppConfigsScreen()),
            GoRoute(path: '/admin/send-notification', builder: (context, state) => const SendNotificationScreen()),
            ...
            GoRoute(path: '/admin/address', builder: (context, state) => const AdminAddressScreen()),
            GoRoute(path: '/admin/users', builder: (context, state) => const AdminUsersScreen()),
            GoRoute(path: '/admin/subscriptions', builder: (context, state) => const AdminSubscriptionPlansScreen()),
            GoRoute(path: '/admin/products', builder: (context, state) => const AdminProductsScreen()),
            GoRoute(path: '/admin/systems', builder: (context, state) => const AdminSystemsScreen()),
          ],
        ),
      ],
    );

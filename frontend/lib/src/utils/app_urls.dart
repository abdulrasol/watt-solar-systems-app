...
class AppUrls {
  ...
  static String get baseUrl {
    if (kReleaseMode) {
      return 'https://abdulrasol.pythonanywhere.com/api/v1'; // TODO: Update to new NestJS host later if needed
    }
    // For Debug Mode:
    // 10.0.2.2 is the special alias to your host loopback interface in Android Emulator
    try {
      if (defaultTargetPlatform == TargetPlatform.android) {
        return 'http://10.0.2.2:3000/api/v1'; // NestJS default port is typically 3000
      }
    } catch (_) {}
  ...
  // ==================== ADMIN ====================
  static String get adminBaseUrl => baseUrl;
  ...
  static String get adminProducts => '$adminBaseUrl/shop/admin/products';
  ...
  static String get adminServiceCatalog => '$adminBaseUrl/service-catalogs';
  ...
  static String get registerCompany => companiesBaseUrl;
  static String get companyTypes => '$baseUrl/company-types';
  ...
  static String get companySubscriptions => '$baseUrl/subscriptions';
  ...
  static String companySubscriptionRequest(int id) => '${company(id)}/subscription-requests';
  ...
  // Company Products
  static String products(int companyId) => '$baseUrl/shop/company-products';
  static String productDetails(int companyId, int productId) => '$baseUrl/shop/company-products/$productId';
  ...
  static String customers(int companyId) => '$baseUrl/shop/company-customers';
  static String customer(int companyId, int customerId) => '$baseUrl/shop/company-customers/$customerId';
  static String suppliers(int companyId) => '$baseUrl/shop/company-suppliers';
  static String supplier(int companyId, int supplierId) => '$baseUrl/shop/company-suppliers/$supplierId';
  static String orders(int companyId) => '$baseUrl/shop/company-orders';
  static String order(int companyId, int orderId) => '$baseUrl/shop/company-orders/$orderId';
  static String updateOrderStatus(int companyId, int orderId) => '${order(companyId, orderId)}/status';
  ...
  // Admin Posters
  static String get adminPosters => '$baseUrl/admin/posters';
  ...
  static String get storefrontProducts => '$shopBaseUrl/store/products';
  ...
  static String get b2cMyOrders => '$shopBaseUrl/my-orders/b2c';
  static String b2cMyOrder(int orderId) => '$b2cMyOrders/$orderId';
  static String get b2cMyOrderCheckout => '$b2cMyOrders/checkout';
  ...
  static String get b2bMyOrders => '$shopBaseUrl/my-orders/b2b';
  static String b2bMyOrder(int orderId) => '$b2bMyOrders/$orderId';
  static String get b2bMyOrderCheckout => '$b2bMyOrders/checkout';
  ...
  static String accountingAccount(int companyId, int accountId) => '$accountingBaseUrl/$companyId/accounts/$accountId';
  static String accountingPayments(int companyId) => '$accountingBaseUrl/$companyId/payments';
  static String accountingBill(int companyId, int billId) => '$accountingBaseUrl/$companyId/bills/$billId';
  static String accountingBills(int companyId) => '$accountingBaseUrl/$companyId/bills';
  static String accountingInvoice(int companyId, int invoiceId) => '$accountingBaseUrl/$companyId/invoices/$invoiceId';
  ...
  static String get adminSystems => '$systemsBaseUrl/admin';
  ...
  static String respondToOffer(int requestId) => '$requestsBaseUrl/$requestId/response';
  ...
  static String get involves => '$_offersBaseUrl/involvements';
  static String involve(int id) => '$involves/$id';

  // Admin Interface
  static String get adminOffers => '$_offersBaseUrl/admin/offers';
  static String get adminRequests => '$_offersBaseUrl/admin/requests';
}

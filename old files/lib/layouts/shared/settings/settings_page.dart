...
import '../../../../../lib/src/features/auth/services/auth_services.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            // Navigation Section
            if (_authController.user.value?.isSuperUser == true) ...[
              _buildSectionHeader('navigation'.tr),
              _buildSettingsCard(
                children: [
                  _buildListTile(
                    icon: Iconsax.home_bold,
                    title: 'Save role page selection'.tr,
                    trailing: Switch(
            ...
            Center(
              child: Text("Version 1.0.0", style: TextStyle(color: Theme.of(context).disabledColor, fontSize: 12)),
            ),
          ],
        ),
      ),

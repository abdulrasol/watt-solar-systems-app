...
import '../../../../../../lib/src/features/calculations/presentation/widgets/save_to_system_dialog.dart';
  ...
  List<Widget> _buildFormFields() {
    return [
      ...
      inputField(
        ...
        controller: current,
        validator: Validatorless.multiple([Validatorless.required('required'.tr), Validatorless.number('numbers'.tr)]),
      ...
      divider,
      Text('Depth of Discharge of Battery ($depthOfDischarge%)', style: Theme.of(context).textTheme.titleMedium, textAlign: TextAlign.start),
      verSpace(space: 8),
      Slider(

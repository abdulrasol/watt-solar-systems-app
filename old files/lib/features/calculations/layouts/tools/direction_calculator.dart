...
class _DirectionCalculatorState extends State<DirectionCalculator> {
  ...
  void initState() {
    ...
    String initialText = controller.orientationLat.value == 0 ? '' : controller.orientationLat.value.toString();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("orientation_calc".tr),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text("Align your solar panels for maximum efficiency.", textAlign: TextAlign.center, style: Theme.of(context).textTheme.bodyMedium),
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    onChanged: (val) {
                      ...
                      controller.orientationLat.value = double.tryParse(val) ?? 0;
            ...
            // Compass Visual
            Obx(() {
              if (controller.orientationLat.value == 0) return SizedBox.shrink();

              double targetHeading = controller.optimalDirection.value == "South" ? 180 : 0; // 0 is North
              double currentHeading = controller.compassHeading.value;
                ...
                children: [
                  Stack(
                    ...
                    children: [
                      ...
                      Transform.rotate(
                        angle: -currentUserHeadingRad(currentHeading) + (controller.optimalDirection.value == "South" ? math.pi : 0),
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
            ...
            // Results Card
            Obx(
              () => controller.orientationLat.value != 0
                  ? Container(
                      padding: const EdgeInsets.all(20),
                      ...
                      child: Column(
                        children: [
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "${controller.optimalTilt.value.toStringAsFixed(1)}°",
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    controller.optimalDirection.value,
                          ...
                          Container(
                            ...
                            child: Text(
                              "For best year-round performance, tilt panels at ${controller.optimalTilt.value.toStringAsFixed(1)}° facing ${controller.optimalDirection.value}.",
  ...
  void _showHelpDialog() {
    final explanations = AppExplanations.getDirectionExplanations();
